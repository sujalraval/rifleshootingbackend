...
const service = __importStar(require("./assets.service"));
...
const create = async (req, res) => {
    try {
        const validatedData = assets_schema_1.createSchema.parse(req.body);
...
const update = async (req, res) => {
    try {
        const validatedData = assets_schema_1.updateSchema.parse(req.body);
