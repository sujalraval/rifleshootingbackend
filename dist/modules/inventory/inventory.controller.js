...
const create = async (req, res) => {
    try {
        const validatedData = inventory_schema_1.createInventorySchema.parse(req.body);
...
const update = async (req, res) => {
    try {
        const validatedData = inventory_schema_1.updateInventorySchema.parse(req.body);
        const data = await inventoryService.update(req.params.id, validatedData);
