...
const service = __importStar(require("./employees.service"));
...
const create = async (req, res) => {
    try {
        const validatedData = employees_schema_1.createSchema.parse(req.body);
...
const update = async (req, res) => {
    try {
        const validatedData = employees_schema_1.updateSchema.parse(req.body);
