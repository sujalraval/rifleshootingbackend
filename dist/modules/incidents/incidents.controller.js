...
const service = __importStar(require("./incidents.service"));
...
const create = async (req, res) => {
    try {
        const validatedData = incidents_schema_1.createSchema.parse(req.body);
...
const update = async (req, res) => {
    try {
        const validatedData = incidents_schema_1.updateSchema.parse(req.body);
