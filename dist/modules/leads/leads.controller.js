...
const service = __importStar(require("./leads.service"));
...
const create = async (req, res) => {
    try {
        const validatedData = leads_schema_1.createSchema.parse(req.body);
...
const update = async (req, res) => {
    try {
        const validatedData = leads_schema_1.updateSchema.parse(req.body);
