...
const service = __importStar(require("./training.service"));
...
const create = async (req, res) => {
    try {
        const validatedData = training_schema_1.createSchema.parse(req.body);
...
const update = async (req, res) => {
    try {
        const validatedData = training_schema_1.updateSchema.parse(req.body);
