...
const create = async (req, res) => {
    try {
        const validatedData = branches_schema_1.createBranchSchema.parse(req.body);
...
const update = async (req, res) => {
    try {
        const validatedData = branches_schema_1.updateBranchSchema.parse(req.body);
        const data = await branchesService.update(req.params.id, validatedData);
