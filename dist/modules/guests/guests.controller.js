...
const service = __importStar(require("./guests.service"));
const guests_schema_1 = require("./guests.schema");
...
const create = async (req, res) => {
    try {
        const validatedData = guests_schema_1.createSchema.parse(req.body);
...
const update = async (req, res) => {
    try {
        const validatedData = guests_schema_1.updateSchema.parse(req.body);
